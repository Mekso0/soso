...
async def handle_document(message: types.Message):
    if message.caption == '/map':
        ...
        with open(file_name, 'wb') as new_file:
            ...
            await message.answer(types.InputFile(nnn), caption="держи свой файл⚡")
            '''
